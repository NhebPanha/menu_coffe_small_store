...
export const menuData = [
  {
    ...
    items: [
      ...
      { id: "c4", kh: "អាយឡាតេ", en: "Iced Latte", zh: "冰拿铁", price: 1.25, oldPrice: 1.75, image: IMG("1517701550927-30cf4ba1dba5") }
    ]
  },
  {
    ...
    items: [
      ...
      { id: "m2", kh: "ម៉ាតឆាស្រ្តបឺរី", en: "Strawberry Matcha", zh: "草莓抹茶", price: 1.50, oldPrice: 2.00, image: IMG("1536256263959-770b48d82b0a") },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "t4", kh: "ប្រោនស៊ូហ្គឺ", en: "Brown Sugar Milk Tea", zh: "黑糖奶茶", price: 1.50, oldPrice: 2.00, image: IMG("1558160074-4d7d8bdf4256") }
    ]
  },
  {
    ...
    items: [
      ...
      { id: "ms4", kh: "សូកូឡាទឹកដោះគោ", en: "Chocolate Milk", zh: "巧克力牛奶", price: 1.50, oldPrice: 2.00, image: IMG("1572490122747-3968b75cc699") }
    ]
  },
  {
  ...
  },
  {
    ...
    items: [
      { id: "cr1", kh: "ផាសិនគ្រីម", en: "Passion Fruit Cream", zh: "百香果奶盖", price: 1.50, oldPrice: 2.00, image: IMG("1505252585461-04db1eb84625") },
